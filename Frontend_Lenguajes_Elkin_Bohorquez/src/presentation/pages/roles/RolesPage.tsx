                ...
                <div className="flex flex-row items-center justify-between bg-blue-500">
                    ...
                    <div className="flex flex-row items-center gap-2">
                        <button
                            ...
                            className={`flex flex-row items-center justify-center gap-2 p-2 ${!rolesPaginationQuery.data?.data.hasPreviousPage
                        ...
                        <button
                            ...
                            className={`flex flex-row items-center justify-center gap-2 p-2 ${!rolesPaginationQuery.data?.data.hasNextPage
                                ? "bg-blue-500 text-white rounded-md cursor-not-allowed"
                                : "bg-blue-500 text-white hover:bg-blue-600 rounded-md cursor-pointer"
                                }`} >
                            <span>Siguiente</span>
